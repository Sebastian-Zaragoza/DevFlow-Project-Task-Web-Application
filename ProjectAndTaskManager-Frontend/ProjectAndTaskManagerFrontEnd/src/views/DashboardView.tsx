            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-lg text-gray-600">Gestiona y administra tus proyectos</p>
                    </div>
                    <Link
                        to="/projects/create"
                                    ...
                                    <div className="flex-1 px-6 py-5">
                                        ...
                                        <div className="mt-3 space-y-1">
                                            <p className="text-sm text-gray-600">
                                                <span className="font-medium text-gray-800">Cliente:</span> {project.clientName}
                                            </p>
                                            <p className="text-sm text-gray-600">
                                                <span className="font-medium text-gray-800">Descripción:</span> {project.description || "(Sin descripción)"}
                                            </p>
                                        </div>
